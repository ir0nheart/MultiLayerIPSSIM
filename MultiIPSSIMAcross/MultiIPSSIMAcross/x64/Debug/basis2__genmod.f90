     ...
     &DFDYG,DWDXG,DWDYG,PITER,UITER,PVEL,POR,THICK,CNUB,THICKG,VXG,VYG, &
     &SWG,SWTG,RHOG,VISCG,PORG,VGMAG,RELKG,RELKTG,PERMXX,PERMXY,PERMYX, &
     &PERMYY,CJ11,CJ12,CJ21,CJ22,GXSI,GETA,RCIT,RCITM1,RGXG,RGYG,LREG,  &
     &SWBG,RELKBG,CNUBG)
